...
- **Geometry** is a set of module constants (`FRAME`, `RIBBON`, `DELTA`, tab and name metrics) drawn as vectors, with gold from `Metal.MATERIALS.gold` and `Metal.bevelFilter`. The ship name auto-shrinks past `NAME_MAXW`.
